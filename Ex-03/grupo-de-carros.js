...
function filtrarCarros(array, number) {
  let carrosCortados = array.splice(number, 3);

  const juntarCarros = carrosCortados.join(" - ");

  return juntarCarros;
}

const resultado = filtrarCarros(carros, index);
